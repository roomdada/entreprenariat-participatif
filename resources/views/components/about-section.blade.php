           ...
           <div class="flex items-center -mx-3 sm:-mx-4">
              <div class="w-full xl:w-1/2 px-3 sm:px-4">
                 <div class="py-3 sm:py-4">
                    <img src="https://us.123rf.com/450wm/michaeljung/michaeljung1302/michaeljung130200277/17781738-beau-homme-d-affaires-afro-am%C3%A9ricain-avec-l-ordinateur-tablette-au-bureau.jpg?ver=6"
                       alt="" class="rounded-2xl w-full" />
                 </div>
                 <div class="py-3 sm:py-4">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYy6sZ-924IfCvPBd31K9hW1jbLPNll2j75g&usqp=CAU"
                       alt="" class="rounded-2xl w-full" />
                 </div>
              </div>
              <div class="w-full xl:w-1/2 px-3 sm:px-4">
                 <div class="my-4 relative z-10">
                    <img src="https://iutea.edu.ci/wp-content/uploads/2020/07/676-72px-1024x1024.jpg"
                       alt="" class="rounded-2xl w-full" />
        ...
        <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
           <div class="mt-10 lg:mt-0">
              ...
              <a href="{{ route('projects') }}"
                 ...
                 rounded-lg
                 ">
              Trouver un projet qui vous convient
              </a>
           </div>
        </div>
     </div>
