<x-app-layout>
  <x-section-header title="Editer la categorie">
    <x-slot name="actions">
      <a href="{{ route('domaines.index') }}" class="btn btn-sm btn-accent">
  ...
  <div class="bg-white px-6 py-12 rounded-md shadow-lg  border-2">
      <livewire:domaines.update-domaine-form  :domaine='$domaine'/>
  </div>
</x-app-layout>
